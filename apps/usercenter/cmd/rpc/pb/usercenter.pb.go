...
var file_usercenter_proto_rawDesc = []byte{
	...
	0x66, 0x74, 0x65, 0x72, 0x32, 0xc1, 0x02, 0x0a, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x63, 0x65, 0x6e,
	...
	0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x12, 0x51, 0x0a, 0x14, 0x67, 0x65, 0x74, 0x55,
...
var file_usercenter_proto_depIdxs = []int32{
	...
	1,  // 1: pb.GetUserAuthyUserIdResp.userAuth:type_name -> pb.UserAuth
	4,  // 2: pb.usercenter.login:input_type -> pb.LoginReq
	2,  // 3: pb.usercenter.register:input_type -> pb.RegisterReq
	6,  // 4: pb.usercenter.getUserAuthByAuthKey:input_type -> pb.GetUserAuthByAuthKeyReq
	8,  // 5: pb.usercenter.getUserAuthByUserId:input_type -> pb.GetUserAuthByUserIdReq
	10, // 6: pb.usercenter.generateToken:input_type -> pb.GenerateTokenReq
	5,  // 7: pb.usercenter.login:output_type -> pb.LoginResp
	3,  // 8: pb.usercenter.register:output_type -> pb.RegisterResp
	7,  // 9: pb.usercenter.getUserAuthByAuthKey:output_type -> pb.GetUserAuthByAuthKeyResp
	9,  // 10: pb.usercenter.getUserAuthByUserId:output_type -> pb.GetUserAuthyUserIdResp
	11, // 11: pb.usercenter.generateToken:output_type -> pb.GenerateTokenResp
