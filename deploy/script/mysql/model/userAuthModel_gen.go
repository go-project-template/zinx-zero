...
var (
	...
	cacheGamexUserAuthIdPrefix              = "cache:gamex:userAuth:id:"
	cacheGamexUserAuthAuthTypeAuthKeyPrefix = "cache:gamex:userAuth:authType:authKey:"
	cacheGamexUserAuthUserIdAuthTypePrefix  = "cache:gamex:userAuth:userId:authType:"
)
...
func (m *defaultUserAuthModel) Insert(ctx context.Context, session sqlx.Session, data *UserAuth) (sql.Result, error) {
	...
	gamexUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheGamexUserAuthAuthTypeAuthKeyPrefix, data.AuthType, data.AuthKey)
	gamexUserAuthIdKey := fmt.Sprintf("%s%v", cacheGamexUserAuthIdPrefix, data.Id)
	gamexUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheGamexUserAuthUserIdAuthTypePrefix, data.UserId, data.AuthType)
	...
	}, gamexUserAuthAuthTypeAuthKeyKey, gamexUserAuthIdKey, gamexUserAuthUserIdAuthTypeKey)
}

func (m *defaultUserAuthModel) FindOne(ctx context.Context, id int64) (*UserAuth, error) {
	gamexUserAuthIdKey := fmt.Sprintf("%s%v", cacheGamexUserAuthIdPrefix, id)
	var resp UserAuth
	err := m.QueryRowCtx(ctx, &resp, gamexUserAuthIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultUserAuthModel) FindOneByAuthTypeAuthKey(ctx context.Context, authType string, authKey string) (*UserAuth, error) {
	gamexUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheGamexUserAuthAuthTypeAuthKeyPrefix, authType, authKey)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, gamexUserAuthAuthTypeAuthKeyKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserAuthModel) FindOneByUserIdAuthType(ctx context.Context, userId int64, authType string) (*UserAuth, error) {
	gamexUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheGamexUserAuthUserIdAuthTypePrefix, userId, authType)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, gamexUserAuthUserIdAuthTypeKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserAuthModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheGamexUserAuthIdPrefix, primary)
}
